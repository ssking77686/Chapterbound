...
- 用户反馈：Toast 通知系统（成功/错误/信息三类型，motion 动画弹出）
- 数据校验：图鉴 JSON 导入运行时结构校验、设置加载类型校验
- 图鉴性能优化：搜索防抖、无限滚动（每批 50 条）、动画延迟上限、图片懒加载
- 代码健康文档：`docs/technical-audit.md` 长期维护的代码库参考
